...
final class ULRequest {
    ...
    private struct Constants {
        ...
        static let baseUrlPROD = "https://api.ulearning.com.pe/api/"
        static let baseUrlQA = "https://www.sandbox.api.ulearning.com.pe/api/"
        static let studentUrl = "https://student.ulearning.com.pe"
    }


    /// Desired endpoint
    let endpoint: ULEndpoint
    ...
    convenience init?(url: URL) {
        ...
        if trimmed.contains("/") {
            ...
            if !components.isEmpty, components.count >= 2 {
                ...
                if let rmEndpoint = ULEndpoint(rawValue: endpointString) {
